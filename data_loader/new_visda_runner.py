...
def loadVisdaData(batch_size=4, unsup_batch_size=12, fullyBalanced=True, useNewUnsupervised=True, unsupDatasetSize=None):
    resNetOrInception = 0
    ...
    datapath = "/scratch/groups/rubin/alimirz1/visda_2017/"
    dataset_train_orig = datasets.ImageFolder(datapath + 'train', transform=transformations)
    dataset_test = datasets.ImageFolder(datapath + 'validation',transform=transformations_valid)
